...
export default function ModusNavbar({
  ...
  const setNavbarRef = useCallback((element: HTMLElement | null) => {
    if (element) {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      const navbar = element as any;
  ...
  }, [userCard, visibility, textOverrides, searchDebounceMs, mainMenuOpen, notificationsMenuOpen, appsMenuOpen, searchInputOpen, userMenuOpen, condensedMenuOpen]);
