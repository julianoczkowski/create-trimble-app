 ...
 * that can be used with the modus-icon Angular component or directly with the modus-icons
 * CSS class.
 *
 * @example
 * // Using with modus-icon Angular component
 ...
 *
 * @example
 * // Display all icons in a grid (Angular template)
 * @for (iconName of allModusIcons; track iconName) {
 *   <modus-icon [name]="iconName" size="sm" [decorative]="true" />
 * }
 *
 ...
 *
 * @example
 * // Display icon count in UI (Angular template)
 ...
 *
 * @example
 * // Display category count (Angular template)
