  ...
  template: `
    ...
    >
      <demo-example title="Basic Number Input" description="Simple number input with label.">
        <div class="flex flex-col gap-6">
          <div class="flex flex-col gap-2">
            <modus-input-label forId="quantity-input" labelText="Quantity" />
            <modus-number-input
          ...
          <div class="flex flex-col gap-2">
            <modus-input-label forId="price-input" labelText="Price" />
            <modus-number-input
              inputId="price-input"
              label="Price"
              placeholder="0.00"
      ...
      <demo-example title="Number Input Sizes" description="Number inputs in different sizes.">
        <div class="flex flex-col gap-6">
          <div class="flex flex-col gap-2">
            <modus-input-label forId="small-number" labelText="Small" />
            <modus-number-input inputId="small-number" label="Small" size="sm" placeholder="0" />
          </div>

          <div class="flex flex-col gap-2">
            <modus-input-label forId="medium-number" labelText="Medium (Default)" />
            <modus-number-input inputId="medium-number" label="Medium" size="md" placeholder="0" />
          </div>

          <div class="flex flex-col gap-2">
            <modus-input-label forId="large-number" labelText="Large" />
      ...
      >
        <div class="flex flex-col gap-6">
          <div class="flex flex-col gap-2">
            <modus-input-label forId="age-input" labelText="Age (1-120)" />
            <modus-number-input
              inputId="age-input"
              label="Age"
          ...
          <div class="flex flex-col gap-2">
            <modus-input-label forId="percentage-input" labelText="Percentage (0-100)" />
            <modus-number-input
          ...
          <div class="flex flex-col gap-2">
            <modus-input-label forId="decimal-input" labelText="Decimal Value (0-10, step 0.1)" />
            <modus-number-input
      ...
      <demo-example title="Currency Number Input" description="Number input with currency symbol.">
        <div class="flex flex-col gap-6">
          <div class="flex flex-col gap-2">
            <modus-input-label forId="usd-input" labelText="USD Amount" />
            <modus-number-input
              inputId="usd-input"
              label="USD Amount"
              placeholder="0.00"
          ...
          <div class="flex flex-col gap-2">
            <modus-input-label forId="eur-input" labelText="EUR Amount" />
            <modus-number-input
              inputId="eur-input"
              label="EUR Amount"
              placeholder="0.00"
      ...
      >
        <div class="flex flex-col gap-6">
          <div class="flex flex-col gap-2">
            <modus-input-label forId="interactive-number" labelText="Enter a Number" />
            <modus-number-input
