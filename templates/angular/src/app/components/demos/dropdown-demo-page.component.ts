  ...
  template: `
    ...
    >
      <demo-example
        ...
        description="Simple dropdown menu with button trigger and menu items."
      >
      ...
      >
        <div class="flex flex-wrap gap-4">
          <modus-dropdown-menu
            buttonAriaLabel="Bottom start menu"
          ...
          <modus-dropdown-menu
            buttonAriaLabel="Bottom end menu"
      ...
      <demo-example
        ...
        description="Dropdown menu with event handling to track menu visibility."
      >
        <div class="p-6 rounded-lg bg-card text-card-foreground border-default">
          <modus-dropdown-menu
            buttonAriaLabel="Interactive menu"
            (menuVisibilityChange)="handleVisibilityChange($event)"
          >
            <span slot="button">Click to Open</span>
            <div slot="menu">
              <modus-menu>
                <modus-menu-item
                  label="Option 1"
          ...
          <div class="mt-4 p-4 rounded-lg bg-muted text-muted-foreground">
            ...
            <div class="text-sm mt-1">{{ selectedItem() }}</div>
          </div>
          }
        </div>
      </demo-example>
...
export class DropdownDemoPageComponent {
  ...
  handleVisibilityChange(event: { isVisible: boolean }): void {
    console.log('Menu visibility changed:', event.isVisible);
  }
