  ...
  template: `
    ...
    >
      ...
      <demo-example
        ...
        description="Display custom content when no results are found."
      >
        <modus-autocomplete
          label="Search Users"
          placeholder="Type to search..."
      ...
      <demo-example
        ...
        description="Require a minimum number of characters before showing results."
      >
        <modus-autocomplete
...
export class AutocompleteDemoPageComponent {
  ...
  readonly noResultsItems = signal<IAutocompleteItem[]>([]);

  readonly minCharsItems = signal<IAutocompleteItem[]>([
