  ...
  return (
    ...
    >
      ...
      >
        <div class="space-y-6">
          <div>
            <div class="text-base font-semibold mb-3 text-foreground">
      ...
      >
        <div class="flex flex-wrap items-center gap-6">
          <div class="flex flex-col items-center gap-2">
            ...
            <div class="text-xs text-muted-foreground">2xs (8px)</div>
          </div>

          <div class="flex flex-col items-center gap-2">
            <i class="modus-icons text-xs">star</i>
            <div class="text-xs text-muted-foreground">xs (10px)</div>
          </div>

          <div class="flex flex-col items-center gap-2">
            <i class="modus-icons text-sm">star</i>
            <div class="text-xs text-muted-foreground">sm (12px)</div>
          </div>

          <div class="flex flex-col items-center gap-2">
            <i class="modus-icons text-base">star</i>
            <div class="text-xs text-muted-foreground">base (14px)</div>
          </div>

          <div class="flex flex-col items-center gap-2">
            <i class="modus-icons text-lg">star</i>
            <div class="text-xs text-muted-foreground">lg (16px)</div>
          </div>

          <div class="flex flex-col items-center gap-2">
            <i class="modus-icons text-xl">star</i>
            <div class="text-xs text-muted-foreground">xl (18px)</div>
          </div>

          <div class="flex flex-col items-center gap-2">
            <i class="modus-icons text-2xl">star</i>
            <div class="text-xs text-muted-foreground">2xl (20px)</div>
          </div>

          <div class="flex flex-col items-center gap-2">
            <i class="modus-icons text-3xl">star</i>
            <div class="text-xs text-muted-foreground">3xl (24px)</div>
          </div>

          <div class="flex flex-col items-center gap-2">
            <i class="modus-icons text-4xl">star</i>
            <div class="text-xs text-muted-foreground">4xl (30px)</div>
          </div>
        </div>
      </DemoExample>
      ...
      >
        <div class="flex flex-wrap items-center gap-6">
          ...
          <div class="flex flex-col items-center gap-2">
            ...
            <div class="text-xs text-muted-foreground">Muted</div>
          </div>
        </div>
      </DemoExample>
    </DemoPage>
