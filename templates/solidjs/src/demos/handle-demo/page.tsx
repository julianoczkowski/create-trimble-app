...
export default function HandleDemoPage() {
  return (
    ...
    >
      ...
      >
        <div class="flex flex-col h-80 border border-border rounded-lg overflow-hidden">
      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="flex h-48 border border-border rounded-lg overflow-hidden">
      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="flex h-40 border border-border rounded-lg overflow-hidden">
            ...
            />
            <div id="size-right-1" class="bg-muted p-4 flex-1 min-w-20" />
          </div>
          <div class="flex h-40 border border-border rounded-lg overflow-hidden">
            ...
            />
            <div id="size-right-2" class="bg-muted p-4 flex-1 min-w-20" />
          </div>
          <div class="flex h-40 border border-border rounded-lg overflow-hidden">
            ...
            />
            <div id="size-right-3" class="bg-muted p-4 flex-1 min-w-20" />
          </div>
          <div class="flex h-40 border border-border rounded-lg overflow-hidden">
            ...
            />
            <div id="size-right-4" class="bg-muted p-4 flex-1 min-w-20" />
          </div>
        </div>
      </DemoExample>
