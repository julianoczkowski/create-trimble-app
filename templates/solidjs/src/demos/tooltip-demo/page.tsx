      ...
      >
        <div class="flex flex-wrap gap-4">
          ...
          <ModusTooltip content="Information icon">
            <i
              class="modus-icons text-lg text-primary"
              role="img"
      ...
      >
        <div class="flex flex-col gap-4">
          <div class="flex items-center gap-2">
            <div class="text-sm text-foreground">Hover over the</div>
            <ModusTooltip content="This term provides additional context when hovered">
              <div class="text-sm text-primary underline cursor-help">
                highlighted term
              </div>
            </ModusTooltip>
            <div class="text-sm text-foreground">for more information.</div>
          </div>
          ...
          <div class="flex items-center gap-2">
            <ModusTooltip content="This is a required field that must be completed">
              <div class="text-sm text-foreground flex items-center gap-1">
                Required Field
                <i
                  class="modus-icons text-xs text-destructive"
                  aria-hidden="true"
                >
                  alert
                </i>
