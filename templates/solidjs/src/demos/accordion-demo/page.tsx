...
const sizeItemsXs = [
  {
    ...
    content: (
      <div class="p-4 text-foreground">Extra small accordion content.</div>
    ),
  },
];
...
const sizeItemsSm = [
  {
    ...
    content: (
      <div class="p-4 text-foreground">Small accordion content.</div>
    ),
  },
];
...
const sizeItemsMd = [
  {
    ...
    content: (
      <div class="p-4 text-foreground">Medium accordion content.</div>
    ),
  },
];
...
const sizeItemsLg = [
  {
    ...
    content: (
      <div class="p-4 text-foreground">Large accordion content.</div>
    ),
  },
];
