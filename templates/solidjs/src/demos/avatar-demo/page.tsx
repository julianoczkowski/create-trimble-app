      ...
      >
        <div class="flex flex-wrap items-center gap-6">
          <div class="flex flex-col items-center gap-2">
            ...
            <div class="text-xs text-muted-foreground">Extra Small (xs)</div>
          </div>
          <div class="flex flex-col items-center gap-2">
      ...
      >
        <div class="flex flex-wrap items-center gap-6">
          <div class="flex flex-col items-center gap-2">
            ...
            <div class="text-xs text-muted-foreground">Circle</div>
          </div>
          <div class="flex flex-col items-center gap-2">
      ...
      >
        <div class="flex flex-wrap items-end gap-8">
          <div class="flex flex-col items-center gap-2">
            ...
            <div class="text-xs text-muted-foreground">xs</div>
          </div>
          <div class="flex flex-col items-center gap-2">
