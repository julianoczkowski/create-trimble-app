...
export default function PanelDemoPage() {
  return (
    ...
    >
      ...
      >
        <div class="p-8 bg-background rounded-lg">
          <ModusPanel
            width="300px"
            height="auto"
            floating
      ...
      >
        <div class="flex flex-wrap gap-4">
          <ModusPanel
            ...
            height="200px"
            header={
              <div class="p-3 border-b border-border text-sm font-medium text-foreground">
                200x200
              </div>
            }
            body={
        ...
        <ModusPanel
          ...
          header={
            <div class="p-4 bg-primary">
              ...
              <div class="text-sm text-primary-foreground opacity-80">
                Latest updates
              </div>
            </div>
          }
          body={
            <div class="p-4">
              <div class="aspect-video bg-muted rounded-lg mb-4 flex items-center justify-center">
                <i class="modus-icons text-4xl text-muted-foreground">
                  image
                </i>
              </div>
              ...
              <div class="flex gap-2">
                <div class="px-2 py-1 bg-muted rounded text-xs text-muted-foreground">
                  Tag 1
                </div>
                <div class="px-2 py-1 bg-muted rounded text-xs text-muted-foreground">
                  Tag 2
      ...
      >
        <div class="flex flex-wrap gap-6 p-6 bg-background rounded-lg">
