          ...
          <div class="bg-card border-default rounded-lg p-6 space-y-4">
            ...
            <div class="space-y-4 text-foreground-80">
              <div class="flex gap-3">
                <div class="flex-shrink-0 w-6 h-6 rounded-full bg-muted-foreground text-background flex items-center justify-center text-sm font-bold">
                  1
                </div>
                <div>
          ...
          <div class="bg-card border-default rounded-lg p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="p-4 bg-card rounded-lg border-thick-dashed">
                ...
                <div class="text-sm text-foreground-60">
                  Up-to-date library documentation for SolidJS, Tailwind,
              ...
              <div class="space-y-3">
                <div class="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div class="text-sm text-foreground-60">
                      SolidJS integration, state management, event handling for
                ...
                <div class="flex items-start gap-2">
                  <i class="modus-icons text-muted-foreground mt-0.5">
                    accessibility
                  </i>
                  <div>
                    <div class="font-medium text-foreground">
